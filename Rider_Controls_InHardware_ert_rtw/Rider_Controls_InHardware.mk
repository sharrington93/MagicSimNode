...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Rider_Controls_InHardware.out
...
PRODUCT_NAME              = Rider_Controls_InHardware
MAKEFILE                  = Rider_Controls_InHardware.mk
COMPUTER                  = PCWIN64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
MODELREF_LINK_RSPFILE_NAME = Rider_Controls_InHardware_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Rider_Controls_InHardware.out
...
DEFINES_ = -DMODEL=Rider_Controls_InHardware -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=1 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=Rider_Controls_InHardware -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO
...
CPP_LDFLAGS_SKIPFORSIL = -l"rts2800_ml.lib" --define BOOT_FROM_FLASH=1
...
CPP_SHAREDLIB_LDFLAGS_SKIPFORSIL = -l"rts2800_ml.lib" --define BOOT_FROM_FLASH=1
...
LDFLAGS_SKIPFORSIL = -l"rts2800_ml.lib" --define BOOT_FROM_FLASH=1
...
SHAREDLIB_LDFLAGS_SKIPFORSIL = -l"rts2800_ml.lib" --define BOOT_FROM_FLASH=1
...
%.obj : $(START_DIR)/Rider_Controls_InHardware_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Rider_Controls_InHardware_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Rider_Controls_InHardware_ert_rtw/%.asm
	$(AS) $(ASFLAGS) "$<"


%.obj : $(START_DIR)/Rider_Controls_InHardware_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
