 ...
 * the Communications System Toolbox. The function uses the algorithm  described 
 ...
 *    m            - exponent of the extension field 
...
/* LocalWords:  Berlekamp MWCOMM DOBERLEKAMP
 */
