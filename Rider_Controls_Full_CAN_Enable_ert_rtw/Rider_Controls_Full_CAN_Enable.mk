...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Rider_Controls_Full_CAN_Enable.out
...
PRODUCT_NAME              = Rider_Controls_Full_CAN_Enable
MAKEFILE                  = Rider_Controls_Full_CAN_Enable.mk
COMPUTER                  = PCWIN64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
MODELREF_LINK_RSPFILE_NAME = Rider_Controls_Full_CAN_Enable_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Rider_Controls_Full_CAN_Enable.out
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Rider_Controls_Full_CAN_Enable_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -I./referenced_model_includes -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/MATLAB/SupportPackages/R2014b/texasinstrumentsc2000/toolbox/target/supportpackages/tic2000/@slCustomizer/../src -I$(MATLAB_ROOT)/toolbox/target/extensions/processor/tic2000/include -I$(MATLAB_ROOT)/toolbox/rtw/targets/common/can/blocks/tlc_c -IC:/MATLAB/SupportPackages/R2014b/texasinstrumentsc2000/toolbox/target/supportpackages/tic2000/@slCustomizer/../inc -IC:/ti/controlSUITE/device_support/f2803x/v125/DSP2803x_common/include -IC:/ti/controlSUITE/device_support/f2803x/v125/DSP2803x_headers/include -I$(MATLAB_ROOT)/toolbox/target/extensions/processor/tic2000/blks/lct/include
...
%.obj : $(START_DIR)/Rider_Controls_Full_CAN_Enable_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Rider_Controls_Full_CAN_Enable_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Rider_Controls_Full_CAN_Enable_ert_rtw/%.asm
	$(AS) $(ASFLAGS) "$<"


%.obj : $(START_DIR)/Rider_Controls_Full_CAN_Enable_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
