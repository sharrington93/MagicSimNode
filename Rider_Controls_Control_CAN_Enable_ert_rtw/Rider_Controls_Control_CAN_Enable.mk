###########################################################################
## Makefile generated for Simulink model 'Rider_Controls_Control_CAN_Enable'. 
## 
## Makefile     : Rider_Controls_Control_CAN_Enable.mk
## Generated on : Sun Mar 01 12:00:06 2015
## MATLAB Coder version: 2.7 (R2014b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Rider_Controls_Control_CAN_Enable.out
...
PRODUCT_NAME              = Rider_Controls_Control_CAN_Enable
MAKEFILE                  = Rider_Controls_Control_CAN_Enable.mk
COMPUTER                  = PCWIN64
...
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
MODELREF_LINK_RSPFILE_NAME = Rider_Controls_Control_CAN_Enable_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Rider_Controls_Control_CAN_Enable.out
...
INCLUDES_BUILDINFO = -I$(START_DIR)/Rider_Controls_Control_CAN_Enable_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(START_DIR)/slprj/ert/_sharedutils -I./referenced_model_includes -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/MATLAB/SupportPackages/R2014b/texasinstrumentsc2000/toolbox/target/supportpackages/tic2000/@slCustomizer/../src -I$(MATLAB_ROOT)/toolbox/target/extensions/processor/tic2000/include -I$(MATLAB_ROOT)/toolbox/rtw/targets/common/can/blocks/tlc_c -IC:/MATLAB/SupportPackages/R2014b/texasinstrumentsc2000/toolbox/target/supportpackages/tic2000/@slCustomizer/../inc -IC:/ti/controlSUITE/device_support/f2803x/v125/DSP2803x_common/include -IC:/ti/controlSUITE/device_support/f2803x/v125/DSP2803x_headers/include -I$(MATLAB_ROOT)/toolbox/target/extensions/processor/tic2000/blks/lct/include
...
DEFINES_ = -DMODEL=Rider_Controls_Control_CAN_Enable -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DONESTEPFCN=1 -DTERMFCN=1 -DMAT_FILE=0 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -DSTACK_SIZE=64
...
DEFINES_STANDARD = -DMODEL=Rider_Controls_Control_CAN_Enable -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO
...
MODELREF_LIBS = ./Rider_Controls_Control_rtwlib.lib
...
%.obj : $(START_DIR)/Rider_Controls_Control_CAN_Enable_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Rider_Controls_Control_CAN_Enable_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/Rider_Controls_Control_CAN_Enable_ert_rtw/%.asm
	$(AS) $(ASFLAGS) "$<"


%.obj : $(START_DIR)/Rider_Controls_Control_CAN_Enable_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
